<?php
  ...
  if(isset($_GET["id"]) && $_GET["id"] != "" && $_GET["id"] != 0)  {
    ...
    die("<div class='alert alert-warning'>Aucun id renseigné</div>");
  }
?>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="checkboxes">Etes-vous sûr de vouloir supprimer cet élève ?</label>
  <div class="col-md-2">
